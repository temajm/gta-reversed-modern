...
{
    HookInstall(0x4AFCF0, (CEventKnockOffBike * (CEventKnockOffBike::*)(CVehicle*, const CVector&, const CVector&, float, float, uint8_t, uint8_t, int32_t, CPed*, bool, bool)) & CEventKnockOffBike::Constructor);
...
CEventKnockOffBike::CEventKnockOffBike(CVehicle* vehicle, const CVector& moveSpeed, const CVector& collisionImpactVelocity, float damageIntensity, float a6, uint8_t knockOffType, uint8_t knockOutDirection, int32_t time, CPed* ped, bool isVictimDriver, bool forceKnockOff)
{
    ...
    field_28 = a6;
    m_ped = ped;
    m_knockOffDirection = knockOutDirection;
...
CEventKnockOffBike* CEventKnockOffBike::Constructor(CVehicle* vehicle, const CVector& moveSpeed, const CVector& collisionImpactVelocity, float damageIntensity, float a6, uint8_t knockOffType, uint8_t knockOutDirection, int32_t time, CPed* ped, bool isVictimDriver, bool forceKnockOff)
{
    this->CEventKnockOffBike::CEventKnockOffBike(vehicle, moveSpeed, collisionImpactVelocity, damageIntensity, a6, knockOffType, knockOutDirection, time, ped, isVictimDriver, forceKnockOff);
    return this;
}
...
// 0x4B0020
int32_t CEventKnockOffBike::CalcForcesAndAnims(CPed* ped)
{
    uint8_t numContactWheels = 0;
    ...
    case KNOCK_OFF_TYPE_SKIDBACKFRONT:
    {
        ...
        ped->m_pEntityIgnoredCollision = m_vehicle;
        int32_t animId = ANIM_ID_KO_SKID_BACK;
        switch (m_knockOffDirection)
        {
        case 0:
