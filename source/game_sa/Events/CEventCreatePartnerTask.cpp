...
CEventCreatePartnerTask::CEventCreatePartnerTask(int32_t randomNumber, CPed* partner, bool leadSpeaker, float distanceMultiplier)
{
...
CEventCreatePartnerTask* CEventCreatePartnerTask::Constructor(int32_t randomNumber, CPed* partner, bool leadSpeaker, float distanceMultiplier)
{
