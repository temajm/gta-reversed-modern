...
CEventAcquaintancePedHateBadlyLit::CEventAcquaintancePedHateBadlyLit(CPed* ped, int32_t startTimeInMs, const CVector& point) : CEventAcquaintancePed(ped)
{
...
CEventAcquaintancePedHateBadlyLit* CEventAcquaintancePedHateBadlyLit::Constructor(CPed* ped, int32_t startTimeInMs, const CVector& point)
{
