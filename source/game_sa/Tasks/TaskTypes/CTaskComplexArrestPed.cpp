...
CTask* CTaskComplexArrestPed::CreateSubTask(int32_t taskId, CPed* ped)
{
    return plugin::CallMethodAndReturn<CTask*, 0x68CF80, CTaskComplexArrestPed*, int32_t, CPed*>(this, taskId, ped);
}
