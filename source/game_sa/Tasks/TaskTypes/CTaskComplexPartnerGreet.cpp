...
CTaskComplexPartnerGreet::CTaskComplexPartnerGreet(const char* commandName, CPed* partner, bool leadSpeaker, float distanceMultiplier, int32_t handShakeType, CVector point) :
...
CTaskComplexPartnerGreet* CTaskComplexPartnerGreet::Constructor(const char* commandName, CPed* partner, bool leadSpeaker, float distanceMultiplier, int32_t handShakeType, CVector point)
{
