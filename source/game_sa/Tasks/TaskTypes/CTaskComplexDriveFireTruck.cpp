...
void CTaskComplexDriveFireTruck::InjectHooks()
{
    ...
    ReversibleHooks::Install("CTaskComplexDriveFireTruck", "CreateSubTask", 0x65A240, &CTaskComplexDriveFireTruck::CreateSubTask);
    //VTABLE
    ReversibleHooks::Install("CTaskComplexDriveFireTruck", "Clone", 0x659BC0, &CTaskComplexDriveFireTruck::Clone_Reversed);
    ReversibleHooks::Install("CTaskComplexDriveFireTruck", "CreateFirstSubTask", 0x65B140, &CTaskComplexDriveFireTruck::CreateFirstSubTask_Reversed);
    ReversibleHooks::Install("CTaskComplexDriveFireTruck", "CreateNextSubTask", 0x65B090, &CTaskComplexDriveFireTruck::CreateNextSubTask_Reversed);
    ReversibleHooks::Install("CTaskComplexDriveFireTruck", "ControlSubTask", 0x65B1E0, &CTaskComplexDriveFireTruck::ControlSubTask_Reversed);
}

CTaskComplexDriveFireTruck* CTaskComplexDriveFireTruck::Constructor(CVehicle* pVehicle, CPed* pPartnerFireman, bool bIsDriver)
{
    this->CTaskComplexDriveFireTruck::CTaskComplexDriveFireTruck(pVehicle, pPartnerFireman, bIsDriver);
    return this;
}

// 0x659310
CTaskComplexDriveFireTruck::CTaskComplexDriveFireTruck(CVehicle* pVehicle, CPed* pPartnerFireman, bool bIsDriver)
{
    m_pVehicle = pVehicle;
    m_pPartnerFireman = pPartnerFireman;
...
CTask* CTaskComplexDriveFireTruck::CreateSubTask(eTaskType taskType, CPed* ped)
{
    ...
    case TASK_SIMPLE_CAR_DRIVE:
        return new CTaskSimpleCarDrive(m_pVehicle, 0, false);
    default:
        return nullptr;
    }
}
