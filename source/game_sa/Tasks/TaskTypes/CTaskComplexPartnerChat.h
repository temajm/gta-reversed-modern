...
public:
    ...
    CTaskComplexPartnerChat(const char* commandName, CPed* partner, bool leadSpeaker, float distanceMultiplier, int8_t updateDirectionCount, bool conversationEnabled, bool a8, CVector point);
    ~CTaskComplexPartnerChat();
private:
    CTaskComplexPartnerChat* Constructor(const char* commandName, CPed* partner, bool leadSpeaker, float distanceMultiplier, int8_t updateDirectionCount, bool conversationEnabled, bool a8, CVector point);
public:
